  ...
  return (
    <main className="relative flex min-h-screen w-full overflow-hidden bg-[#F8FAFC] text-[#071938] select-none lg:fixed lg:inset-0 lg:h-screen lg:min-h-0">
      ...
      >
        ...
        <div className="register-left-brand relative z-10">
        ...
        <div className="register-left-hero relative z-10 mt-[44px] grid max-w-[780px] grid-cols-[minmax(380px,450px)_1fr] items-start gap-x-2 xl:mt-[52px] xl:max-w-[840px] xl:grid-cols-[minmax(450px,500px)_1fr]">
          <div className="relative z-20">
            <h1 className="text-[26px] font-extrabold leading-[1.22] tracking-normal xl:text-[32px] xl:leading-[1.28]">
              Buat Akun Baru dan
              <br />
              Mulai Kirim <span className="text-[#FF7A1A]">Email Sekarang</span>
            </h1>
            <p className="mt-5 max-w-[380px] text-[12px] leading-[1.6] text-slate-100/88 xl:mt-7 xl:max-w-[410px] xl:text-[14px] xl:leading-[1.72]">
              Daftar gratis dan rasakan pengalaman pengiriman email transaksional
              terbaik bersama RealSend.
            </p>
      ...
      <section className="relative flex h-screen min-h-0 flex-1 flex-col items-center justify-center overflow-hidden px-5 py-5 sm:px-8 lg:px-10">
        ...
        <div className="register-form-shell relative z-10 w-full max-w-[400px] -translate-y-1 lg:-translate-x-6 xl:max-w-[430px] xl:-translate-x-10 xl:translate-y-0">
          <SignupForm />
        </div>

        <div className="register-trust-badges pointer-events-none absolute bottom-7 left-1/2 z-10 hidden w-max -translate-x-1/2 flex-nowrap items-center justify-center gap-x-5 whitespace-nowrap text-[11px] font-bold text-[#6D7E9C] lg:flex xl:bottom-8 xl:gap-x-7 xl:text-[12px]">
