...
function SignupFormContent({
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="rounded-[8px] border border-[#DCE3EE] bg-white/96 px-4 pb-5 pt-6 shadow-[0_8px_24px_rgba(21,37,65,0.05)] backdrop-blur-sm sm:px-7 sm:pb-6 sm:pt-8">
        <CardHeader className="space-y-3 pb-3 text-center">
          ...
          <div className="space-y-1.5">
            ...
            <CardDescription className="mx-auto max-w-[320px] text-[13px] leading-6 text-[#647490]">
              Mulai kirim email transaksional dengan kehandalan tinggi dalam
              beberapa menit saja
            </CardDescription>
          </div>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="name" className="text-[12px] font-extrabold text-[#20304A]">
                Nama Lengkap
              </label>
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="password" className="text-[12px] font-extrabold text-[#20304A]">
                Password
              </label>
              <div className="relative w-full">
                <span className="absolute left-5 top-1/2 -translate-y-1/2 text-[#91A3BD] pointer-events-none flex items-center">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 flex cursor-pointer items-center rounded-[8px] p-1.5 text-[#91A3BD] transition-colors hover:bg-slate-100/70 hover:text-[#52657F] focus:outline-none"
                  aria-label={
